...
let questionsStairs = [
  new Question(
    ...
    [
      ...
      `Even small children who are crawling could possibly pull themselves up on the steps and fall. Put a baby gate up now just in case and it will also help you start the habit once your child is able to walk. You should also put door knob covers on doors that lead to rooms where there are stairs.`,
...
let questionsWindow = [
  new Question(
    `Tom and Allison are first-time parents and are excitedly babyproofing their home before the baby is born. They were told that it is important to put window guards on windows to make sure children don’t fall out. However, they have window screens in all their windows so they aren’t sure if they really need to bother with window guards. What is the BEST advice you would you give these new parents? `,
    [
...
let questionsWater = [
  new Question(
    `Sara is having her niece and nephew over to her new house for the first time. Her sister, the children’s mother, wants to make sure Sara has the home childproofed for her two kids who are both under the age of four. Sara goes through a child proof recommendations list she finds online. However, she ignores the section of the check lists that is labeled “water” because she doesn’t own a pool. What are some hazards that Sara should know about related to water hazards for small children in the home?`,
    [
...
let questionsBaby = [
  new Question(
    ...
    [`True`, `False`],
    1,
    `False: Placing an infant or small child in their car seat carrier on a table top, counter, or any other high surface is a falls hazard. A squirming or moving child can cause the entire carrier to fall over, which could cause serious injuries.`,
    `RATIONALEINCORRECT`
  ),
  ...
  new Question(
    ...
    [`True`, `False`],
    1,
    `False: Many products sold for children are not recommended by the Consumer Product Safety Commission for use. Baby walkers are a good example. The American Academy of Pediatricians discourages baby walkers being used because they have been known to cause falls. A safer choice is “saucer” shaped play station that does not move or a play pen area. Before buying products for your child it is always a good idea to visit cpsc.gov and search for any warnings or recalls.`,
    `RATIONALEINCORRECT`
  ),
...
let questionsFurniture = [
  new Question(
    ...
    [`True`, `False`],
    1,
    `False: Children die every year from climbing up furniture that causes that TV to tip over andfall on top of them. Prevent TV tip overs by purchasing products that anchor your TV to the wall.`,
    `RATIONALEINCORRECT`
  ),

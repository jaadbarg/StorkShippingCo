...
// let questionsWindow = [
//   new Question(
//     `Tom and Allison are first-time parents and are excitedly babyproofing their home before 
//     the baby is born. They were told that it is important to put window guards on windows to make sure 
//     children don’t fall out. However, they have window screens in all their windows so they aren’t sure 
//     if they really need to bother with window guards. What is the BEST advice you would you give these 
//     new parents? `,
//     [
//       `The window screen is strong enough to prevent children from falling. 
//     Don’t waste your money on window guards. `,
//       `The window screen isn’t strong enough to prevent children from falling out the window, but if you don’t
...
//     that could be climbed on away from windows for extra protection`,
//     ],
//     2,
//     `RATIONALECORRECT`,
//     `RATIONALEINCORRECT`
...
// let questionsWater = [
//   new Question(
//     `Sara is having her niece and nephew over to her new house for the first time. Her sister,
//     the children’s mother, wants to make sure Sara has the home childproofed for her two kids who are both 
//     under the age of four. Sara goes through a child proof recommendations list she finds online. However,
//     she ignores the section of the check lists that is labeled “water” because she doesn’t own a pool. What 
//     are some hazards that Sara should know about related to water hazards for small children in the home?`,
//     [
...
//   new Question(
//     `True or False: While fencing in a pool is very important to keep young children from 
...
// let questionsBaby = [
//   new Question(
//     `True or False: If an infant or small child is snugly secured in their car seat carrier, 
//     the safest place for them to be placed is at eye level with a parent for supervision in places such as 
...
//   new Question(
//     `True or False: If a product or toy for a child is sold at well known and trusted brands such 
//     as Costco, Wal-Mart, or Target that guarantees the product’s safety. `,
//     [`True`, `False`],
//     1,
//     `False: Many products sold for children are not recommended by the Consumer Product Safety Commission 
...
//   new Question(
//     `True or False: To avoid TV tip-overs it is best to place your TV on a 
...
//   new Question(
//     `Derek is so proud of his four year old son for not being scared of the dark. He told his 

...
let questionsWindow = [
    new Question(`Tom and Allison are first-time parents and are excitedly babyproofing their home before 
...
let questionsWater = [
    new Question(`Sara is having her niece and nephew over to her new house for the first time. Her sister,
...
let questionsBaby = [
    ...
    new Question(`True or False: If an infant or small child is snugly secured in their car seat carrier, 
...
let questionsFurniture = [
    new Question(`True or False: To avoid TV tip-overs it is best to place your TV on a 
